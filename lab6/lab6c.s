...
MAIN:
	...
	BSET PWME,#%00010000	;ENABLE PWM CHANNEL 4 ; PP4 outputs waveform
;	BCLR PWME,BIT4
	BSET PWMPOL,#%00010000 ;CHANNEL 4 ACTIVE HIGH
	;BCLR PWMCLK,BIT4 ;CHANNEL 4 CLOCK A (0 = A or B ; 1 = SA or SB)
	BSET PWMCLK,#%00010000 ;CHANNEL 4 CLOCK SA	
	MOVB #$02,PWMPRCLK ;PWM CLOCK A SCALE=4
	MOVB #75,PWMSCLA ; SA = A/(2*75) = A / 150
	MOVB #200,PWMPER4 ;PWM CHANNEL 4 PERIOD = 20ms
	MOVB #15,PWMDTY4 ;PWM CHANNEL 4 DUTY CYCLE = 5%
